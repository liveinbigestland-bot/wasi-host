...
| **ext** | ssh-metaai.alwaysdata.net | metaai / (password) | x86_64 | 外网中继服务器 (UDP inbound blocked) |
...
| ext | config-ext-server.json | /home/metaai/config-ext-server.json |
| 外2 | config-ext-node2.json | /root/config-ext-node2.json |

## 远程路径

- Binary: /root/wasi-host (ARM/外2) / /home/metaai/wasi-host (ext)
- Log: /root/test-remote-node{59,60}.log / /root/test-ext-node2.log
- Ext log: /home/metaai/test-ext-server.log
...
5. **UDP**: 外网服务器 alwaysdata 屏蔽 inbound UDP，需要代理层
